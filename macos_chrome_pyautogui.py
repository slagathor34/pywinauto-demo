...
class ChromeYouTubeAutomator:
    ...
    def open_chrome(self):
        ...
        search_bar_location = pyautogui.locateCenterOnScreen('youtube_search_bar.png', confidence=0.8)
        ...
        subscribe_button = pyautogui.locateCenterOnScreen('youtube_subscribe_button.png', confidence=0.8)
        if search_bar_location:
